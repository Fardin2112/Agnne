...
const LightPresets = ({ onSelect }) => {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium text-gray-300">Quick Presets</h3>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {presets.map(preset => (
          <button
            ...
            style={{
              background: `linear-gradient(135deg, rgba(${preset.red * 2.55}, 0, ${preset.blue * 2.55}, 0.3), rgba(0, 0, 0, 0.7))`,
